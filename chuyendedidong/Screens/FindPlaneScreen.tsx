...
const FindPlaneScreen = ({navigation}: {navigation: any}) => {
    ...
    return (
        <ScrollView>
            <ImageBackground source={require('../images/giamgia/hn_singapo.jpg')} style={{ height: 80, marginBottom: 50 }}>
            ...
            <ScrollView style={{flexDirection: 'row'}}>
                ...
                <TouchableOpacity style={styles.flight} onPress={() => navigation.navigate('Detail')}>
                    <Image source={require('../images/giamgia/hn_singapo.jpg')} style={styles.avt} />
                    <View>
                        <Text style={styles.locate}>Từ:</Text>
                        <Text style={styles.loc}>Hà Nội</Text>
                        <Text style={styles.date}>Ngày: 6/10</Text>
