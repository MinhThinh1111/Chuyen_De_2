...
const FlightScreen = ({ navigation }: { navigation: any }) => {
    const [text, setText] = useState('');
    const images = [
        require('../images/giamgia/slider1.jpg'),
        require('../images/giamgia/slider2.jpg'),
        require('../images/giamgia/slider3.jpg'),
        require('../images/giamgia/slider4.jpg'),

    ]
    return (
        <ScrollView>
            <ImageBackground source={require('../images/giamgia/Bg.jpg')} style={{ height: 200, marginBottom: 100 }} >
                <View>
            ...
            <View style={{ flexDirection: 'row' }}>
                <View style={styles.imformation}>
                    ...
                    <TouchableOpacity style={styles.btn}>
                        <Text style={styles.btnFind} onPress={() => navigation.navigate('Find')}>Tìm kiếm</Text>
                    </TouchableOpacity>
                </View>
            </View>
            <View>
