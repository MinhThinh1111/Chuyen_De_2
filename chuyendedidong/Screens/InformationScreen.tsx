    ...
    return (
        <View>
            ...
            <View style={styles.box}>
                <Image source={require('../images/box.png')} style={{ height: 60, width: 60, margin: 20 }} />
            ...
            <View style={{ flexDirection: 'row' }}>
                ...
                <View style={styles.detail}>
                    <View style={{ flexDirection: 'row' }}>
                        <Text style={styles.detailLoc}>Tu:</Text>
                    ...
                    <View style={{ flexDirection: 'column' }}>
                        ...
                        <Image source={require('../images/logo/vietjet.jpg')} style={{ marginLeft: 50, marginTop: 5, height: 15, width: 35}} />
                    </View>
            ...
            <TouchableOpacity style={styles.btn} onPress={() => navigation.navigate('Confirm')}>
